...
def wishMe():
    ...
    if hour>=6 and hour<12:
        speak("Good Morning Dilmurod Rakhmatov!")

    elif hour>=12 and hour<18:
        speak("Good Afternoon Dilmurod Rakhmatov!")

    elif hour>=18 and hour<24:
        speak("Good Evening Dilmurod Rakhmatov!")

    else:
        speak("Good Night Dilmurod Rakhmatov!")
...
def takeCommand():
    ...
    try:
        ...
        print(f"Dilmurod Rakhmatov Said:{query}\n")
